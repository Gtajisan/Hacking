...
def main():
	...
	print "   [08] Other\n"
	print "   [10] Exit the Gtajisanxxx\n"
	Gtajisanxxx = raw_input("lzmx > ")
	
	if Gtajisanxxx == "1" or Gtajisanxxx == "01":
		print "\n    [01] Nmap"
		print "    [02] Red Hawk"
		print "    [03] D-Tect"
		print "    [04] sqlmap"
	...
	elif Gtajisanxxx == "2" or Gtajisanxxx == "02":
		print "\n    [01] Nmap"
	...
	elif Gtajisanxxx == "3" or Gtajisanxxx == "03":
		print "\n    [01] Torshammer"
		print "    [02] Slowloris"
	...
	elif Gtajisanxxx == "4" or Gtajisanxxx == "04":
		print "\n    [01] Hydra"
	...
	elif Gtajisanxxx == "5" or Gtajisanxxx == "05":
		print "\n    [01] sqlmap"
		print "    [02] Webdav"
		print "    [03] xGans"
		...
		if webhack == "01" or webhack == "1":
			...
			timeout(2)
			restart_program()
	elif Gtajisanxxx == "6" or Gtajisanxxx == "06":
		print "\n    [01] Metasploit"
		print "    [02] commix"
		print "    [03] sqlmap"
		print "    [04] Brutal"
		...
		if exploitool == "01" or exploitool == "1":
			...
			timeout(2)
			restart_program()
	elif Gtajisanxxx == "7" or Gtajisanxxx == "07":
		print "\n    [01] KnockMail"
	...
	elif Gtajisanxxx == "8" or Gtajisanxxx == "08":
		print "\n    [01] SpiderBot"
		print "    [02] Ngrok"
		print "    [03] Sudo"
		print "    [04] Ubuntu"
