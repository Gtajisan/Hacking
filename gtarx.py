...
def restart_program():
        ...
        curdir = os.getcwd()
os.system("clear")
os.system("figlet Gtajisan")
print "Create By : Gtajisan"
print "YouTube   : https://www.youtube.com/c/HA-MRX"
print "github    : https://github.com/Gtajisan"
print "Facebook  : https://www.facebook.com/farhan muh tasim"
print "Website   : https://kurdkali.wordpress.com/"
print "Twitter   : https://twitter.com/jisangta"
print
print "           [1]> Brute Force              "
print "           [2]> DDos Attack              "
